                ...
                userProfile && userProfile.username ? <>
                    ...
                    <main className={"userProfileMain"}>
                            ...
                            <div className="left col-lg-4">
                                ...
                                <div className="stats row_profile">
                                    ...
                                    <div className="stat col-xs-4" style={{paddingLeft: "50px"}}>
                                        <p className="number-stat">{userArticles ? userArticles.length : 0}</p>
                        ...
                        <div className="userArticles">
                            <h1>Articles</h1>
                            <hr/>
                            {userArticles ? userArticles.map(article => <><Article article={article}/>
                                <hr/>
                            </>) : null}
                            {!userArticles ? <h3>No articles yet</h3>:null}
                        </div>
                    </main>
